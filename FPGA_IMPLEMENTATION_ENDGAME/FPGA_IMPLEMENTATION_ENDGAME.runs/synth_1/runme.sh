...
HD_PWD='C:/Users/JAY/Downloads/THE_ENDGAME_FPGA/FPGA_IMPLEMENTATION_ENDGAME/FPGA_IMPLEMENTATION_ENDGAME.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CACHE_CONTROLLER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CACHE_CONTROLLER.tcl
