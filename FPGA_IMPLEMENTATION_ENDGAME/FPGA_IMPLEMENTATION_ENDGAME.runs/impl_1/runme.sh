...
HD_PWD='C:/Users/JAY/Downloads/THE_ENDGAME_FPGA/FPGA_IMPLEMENTATION_ENDGAME/FPGA_IMPLEMENTATION_ENDGAME.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CACHE_CONTROLLER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CACHE_CONTROLLER.tcl -notrace
